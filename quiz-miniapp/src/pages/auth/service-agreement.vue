...
import { LEGAL_DEFAULT_APP_NAME, LEGAL_UPDATED_AT, getServiceAgreementSections } from "./legal";
import { useAppStore } from "@/stores/app";

const appStore = useAppStore();

const appName = computed(() => appStore.siteConfig.siteName || LEGAL_DEFAULT_APP_NAME);
const sections = computed(() => getServiceAgreementSections(appName.value));
