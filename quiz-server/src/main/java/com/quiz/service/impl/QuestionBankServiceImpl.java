...
public class QuestionBankServiceImpl implements QuestionBankService {
    ...
    public PageResult<QuestionBank> pageList(Long categoryId, String keyword, Integer pageNum, Integer pageSize) {
        QueryWrapper query = QueryWrapper.create()
                ...
                .and(QUESTION_BANK.NAME.like(keyword).when(keyword != null && !keyword.isBlank()))
    ...
    @Override
    public PageResult<QuestionBank> pageEnabledList(Long categoryId, Integer pageNum, Integer pageSize) {
        QueryWrapper query = QueryWrapper.create()
                .where(QUESTION_BANK.CATEGORY_ID.eq(categoryId).when(categoryId != null))
    ...
    @Override
    public void evictCache(Long bankId) {
        clearCache(bankId);
    }
